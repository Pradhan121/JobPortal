...
export default function Home() {
  ...
  return (
    <>
      ...
      >
        <Container maxWidth={false} disableGutters>
          <Typography sx={{ fontSize: "42px", fontWeight: 700, paddingTop:'70px'}}>
            Find Your Dream Job
          </Typography>

          <Typography sx={{ mt: 2, fontSize: "18px", color: "#cbd5e1" }}>
      ...
      <Container>
        ...
        <Grid container spacing={3}>
          {jobs.slice(0, 3).map((job) => (
            <Grid size={{ lg: 4, sm: 6, md: 4, xl: 12 }} key={job._id}>
              <Card
                sx={{
                  background: "#020617",
    ...
    <Box sx={{ background: "#020617", py: 3, borderTop: "1px solid #1e293b" }}>
      <Container>
